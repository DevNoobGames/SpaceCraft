...
public class World : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        step = Mathf.PingPong(Time.time, 20) / 20;
    ...
    void GenerateWorld()
    {
        ...
        MarkusTest.transform.position = new Vector3(spawnPosition.x + 25, spawnPosition.y, spawnPosition.z);
        CheckViewDistance();
    ...
    public void spawnMarkus(Vector3 pos)
    {
        float randval = Random.value;
        if (randval < 0.2 && Mathf.Abs((player.transform.position - pos).x) > 40) 
        {
            //spawn a markus
            Instantiate(Resources.Load("Enemy"), new Vector3(pos.x, 500, pos.z), Quaternion.identity);
        }
    }
